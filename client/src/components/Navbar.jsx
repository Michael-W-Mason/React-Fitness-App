...
const NavBar = (props) => {
    return (
        <div>
            <nav className="sticky flex items-center top-0 z-50 p-2 bg-blue-700 max-h-66">
                {/* Title of Company */}
                    ...
                    <div className="flex items-center gap-20 text-gray-200">
                        ...
                        <div id="dropdownGoal" className="z-10 hidden bg-gray-50 divide-y divide-gray-100 rounded shadow w-44">
                            <ul className="py-1 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <Link to="/Home" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</Link>
                                </li>
                                <li>
                                    <Link to="/Home" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add a Goal</Link>
                                </li>
                            </ul>
                        </div>
